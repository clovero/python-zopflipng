...
def png_optimize(
    ...
    Compress the image by calling this method
        usage：
            ...
            # Compress perfect and trying all filter strategies
    ...
    :param keep_chunks: keep metadata chunks with these names that would normally be removed.
        example:  keep_chunks=['tEXt','zTXt','iTXt','gAMA']
